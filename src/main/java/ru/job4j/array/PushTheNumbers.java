...
Вы должны написать метод который принимает в качестве параметров
двумерный массив(количество рядов должно быть равно количеству строк),
массив заполнен случайными числами от 1 до 100, и два индекса
        индекс строки и индекс колонки.

        В данную ячейку записывается 0 а все цифры левее,
        правее, выше и ниже сдвигаются на 1 ячейку
